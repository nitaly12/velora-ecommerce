            ...
            <div className="w-full max-w-md space-y-8 rounded-2xl bg-white p-8 shadow-lg">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-slate-600">
                        {view === 'sign_in' ? 'Sign in to access your account' : 'Enter your details to get started'}
                    </p>
                </div>
                    ...
                    <div className="space-y-4 rounded-md shadow-sm">
                        <div>
                            <Input
                                ...
                                type="email"
                                required
                                className="relative block w-full appearance-none rounded-xl border border-slate-300 px-3 py-2 text-slate-900 placeholder-slate-500 focus:z-10 focus:border-slate-500 focus:outline-none focus:ring-slate-500 sm:text-sm"
